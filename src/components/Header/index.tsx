...
export default function Header() {
    return (
        <div className={styles.container}>
            <img className={styles.logo} src="/images/logo.webp" alt="Logomarca Neto Baterias" title="Logomarca Neto Baterias"/>
            ...
            <div className={styles.mobileInformationBox}>
                ...
                <a href="https://wa.me/5574988623412" target="_blank" title="Neto Baterias WhatsApp Chat">
